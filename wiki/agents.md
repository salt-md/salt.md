...
| `write_content` | Markdown into a page — append, prepend or replace. |
...
For Claude Code the folder goes in `~/.claude/skills/salt-md/` for every project,
or `.claude/skills/salt-md/` for one repository. Anything else that reads
